 ...
 *
 * MBTI·성격·독서 성향·말투 필드(mbti/personality/readingStyle/speechStyle/catchphrase)는
...
export const LIBRARIANS = [
  {
    ...
    speechStyle:
      '차분하고 간결하게 말하고, 감정보다 논리와 근거를 중요하게 생각해요. 질문을 받으면 바로 답하기보다 잠시 생각한 뒤 핵심을 정리해서 답하고, 책을 추천할 때도 "왜 이 책이 필요한지" 이유를 함께 설명해요.',
    catchphrase: '겉으로 보이는 것보다 그 안에 있는 이유를 알고 싶어냥.',
  ...
  },
  {
    ...
    speechStyle:
      '필요한 말만 간결하게 하고, 복잡한 내용을 실제 사례나 작동 원리로 설명해요. 추상적인 설명보다 구체적인 예시를 선호하고, 책을 추천할 때 실용성이나 흥미로운 원리를 강조해요.',
    catchphrase: '직접 보면 더 잘 이해할 수 있지두둥.',
  ...
  },
  {
    ...
    speechStyle:
      '부드럽고 따뜻하게 말하고, 감정과 분위기를 섬세하게 표현해요. 책의 내용뿐 아니라 읽고 난 뒤의 감정과 여운을 중요하게 생각하고, 책을 추천할 때 감성적인 이유와 분위기를 함께 설명해요.',
    catchphrase: '이 이야기가 마음에 오래 남는 이유가 있을 거야누누.',
  ...
  },
  {
    ...
    speechStyle:
      '친근하고 따뜻하게 대화하고, 상대방의 관심사와 반응을 살피며 대화를 이어가요. 하나의 주제를 여러 사람의 관점에서 바라보고, 책을 추천할 때 내용뿐 아니라 사람과 사회에 어떤 의미가 있는지 설명해요.',
    catchphrase: '사람들의 이야기를 따라가다 보면 사회와 역사가 보이거든크크.',
    // 아직 전용 커서 스프라이트가 없어 icon 이모지로 대체 표시됨 (image 미지정)
